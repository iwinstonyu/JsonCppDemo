...
macro(m_inc_dir_loong_sdk)
	include_directories("${CMAKE_SOURCE_DIR}/External/Loong SDK/Inc")
	include_directories("${CMAKE_SOURCE_DIR}/External/Loong SDK/External")
endmacro()

macro(m_inc_dir_socket)
	include_directories("${CMAKE_SOURCE_DIR}/External/Socket/Include")
endmacro()

macro(m_inc_dir_db)
	include_directories("${CMAKE_SOURCE_DIR}/External/DB/Include")
endmacro()

macro(m_inc_dir_socket_host)
	include_directories("${CMAKE_SOURCE_DIR}/Src/SocketHost/Include")
endmacro()

macro(m_inc_dir_boost)
	include_directories("${CMAKE_SOURCE_DIR}/External/boost/Include")
endmacro()

macro(m_inc_dir_jsoncpp)
	include_directories("${CMAKE_SOURCE_DIR}/External/JsonCpp/1.8.1/Include")
endmacro()

macro(m_inc_dir_protobuf)
	include_directories("${CMAKE_SOURCE_DIR}/External/Protobuf/3.5.2/Include")
endmacro()

macro(m_inc_dir_rapidjson)
	include_directories("${CMAKE_SOURCE_DIR}/External/rapidjson/Include")
endmacro()

macro(m_inc_dir_snappy)
	include_directories("${CMAKE_SOURCE_DIR}/External/Snappy/1.1.7/Include")
endmacro()

macro(m_inc_dir_protomsg)
	include_directories("${CMAKE_BINARY_DIR}/Src/ProtoMsg/Include")
endmacro()

macro(m_inc_dir_protomsg_wrapper)
	include_directories("${CMAKE_SOURCE_DIR}/Src/ProtoMsg")
endmacro()

macro(m_inc_dir_pnb)
	include_directories("${CMAKE_SOURCE_DIR}/External/pnb/Include")
endmacro()

macro(m_inc_dir_slgcody)
	include_directories("${CMAKE_SOURCE_DIR}/External/SlgCody/Include")
endmacro()
